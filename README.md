...
- 💾 **Интеграция с Google Sheets** - автоматическое сохранение всех инцидентов
...
- **Google Sheets API** - База данных инцидентов
...
4. **Уведомление** - отправка в группу и ответственному
5. **Напоминания** - за 60, 30 и 10 минут до дедлайна
6. **Решение** - ответственный закрывает через `/resolve`
